		...
		<div class="row pt-3">
			...
			<div class="col-md-10">
                ...
                if (count($jeux) !== 0) {
                    ...
                    $critere1_scratch_labels = ["Injouable", "x", "x", "x", "Agréable", "Intuitif, Fluide et trés agréable"];
                    ...
                    $critere2_scratch_labels = ["Injouable", "x", "x", "x", "Agréable", "Intuitif, Fluide et trés agréable"];
                    ...
                    $critere3_scratch_labels = ["Injouable", "x", "x", "x", "Agréable", "Intuitif, Fluide et trés agréable"];
                    ...
                    $critere4_scratch_labels = ["Injouable", "x", "x", "x", "Agréable", "Intuitif, Fluide et trés agréable"];
                                ...
                                if ($json !== FALSE) {
                                    ...
                                    <div class="row mb-5">
                                        ...
                                        <div class="col-md-5 pt-5">
                                            ...
                                            @for ($n = 1; $n <= 4; $n++)
                                                <div class="text-uppercase" style="color:#cf63cf">{{ ${'critere'.$n.'_scratch_titre'} }} <sup class="text-dark "style="cursor:help;" data-html="true" data-toggle="tooltip" data-placement="top" title="{{ ${'critere'.$n.'_scratch_description'} }}"><i class="fa-solid fa-circle-question"></i></sup></div>
                                                <div id="{{$jeu->id}}_critere{{$n}}_label" class="text-monospace small text-muted"><span class='text-danger'>Non évalué</span></div>
                                                <div class="row mb-2">
                                                    <div class="col">
                                                        <input type="range" id="{{$jeu->id}}_critere{{$n}}" name="evaluation[{{$jeu->id}}]['critere{{$n}}']" data-labels="{{json_encode(${'critere'.$n.'_scratch_labels'})}}" class="custom-range" value="-1" min="-1" max="5" step="1" oninput="curseur(this.id, this.value, this.dataset.labels);">
                                                    </div>
                                                    <div class="col-auto text-secondary text-center font-weight-bold" id="{{$jeu->id}}_critere{{$n}}_note" style="width:40px;">
                    ...
                    $critere1_python_labels = ["Injouable", "x", "x", "x", "Agréable", "Intuitif, Fluide et trés agréable"];
                    ...
                    $critere2_python_labels = ["Injouable", "x", "x", "x", "Agréable", "Intuitif, Fluide et trés agréable"];
                    ...
                    $critere3_python_labels = ["Injouable", "x", "x", "x", "Agréable", "Intuitif, Fluide et trés agréable"];
                    ...
                    $critere4_python_labels = ["Injouable", "x", "x", "x", "Agréable", "Intuitif, Fluide et trés agréable"];
...
@endforeach
    ...
    <script>
    function curseur(id, note, labels) {
        if (note == "-1") {
            document.getElementById(id+"_note").innerHTML = '<i class="fas fa-times text-danger">';
            document.getElementById(id+"_label").innerHTML = "<span class='text-danger'>Non évalué</span>";
        } else {
            document.getElementById(id+"_note").innerHTML = note;
            document.getElementById(id+"_label").innerHTML = JSON.parse(labels)[note];
        }
