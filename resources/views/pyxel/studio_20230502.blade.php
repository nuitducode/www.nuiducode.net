...
if (!Storage::exists('public/pyxel/projects/'.$token_public)){
	...
	Storage::copy('public/pyxel/init/init.py', 'public/pyxel/projects/'.$token_public.'/app.py');
...
$py_file = (isset($code_file)) ? Crypt::decryptString($code_file) : "app.py";
...
<body>
						...
						<td style="height:100%">
							...
							<div class="tab-content h-100" id="pills-tabContent">
								...
								<div class="tab-pane fade {{$tab_content_files}}" id="pills-files" role="tabpanel" aria-labelledby="pills-files-tab" tabindex="0">
									...
									<ul class="mt-5 list-group mt-2 font-monospace small mb-5">

										<li class="list-group-item d-flex justify-content-between align-items-center p-1 pe-3">
											<span class="small">
												<a href="/pyxel/studio/{{$token_private}}/{{Crypt::encryptString('app.py')}}" class="btn btn-light btn-sm" role="button" data-bs-toggle="tooltip" data-bs-placement="left" data-bs-title="ouvrir" style="width:35px"><i class="fa-solid fa-bars-staggered"></i></a>
												app.py
											</span>
											<span>
												<a href="{{Storage::url('pyxel/projects/'.$token_public.'/app.py')}}" class="download_file" data-bs-toggle="tooltip" data-bs-placement="left" data-bs-title="télécharger" download><i class="fa-solid fa-circle-down"></i></a>
											</span>
										</li>
										<li class="list-group-item d-flex justify-content-between align-items-center p-1 pe-3">
										<span class="small">
										...
										foreach ($fichiers as $fichier) {
											...
											if (is_file($dossier.$fichier)) {
												...
												<li class="list-group-item d-flex justify-content-between align-items-center p-1 pe-3">
													...
													<span><a href="'.Storage::url('pyxel/projects/'.$token_public.'/'.$fichier).'" class="download_file me-0" data-bs-toggle="tooltip" data-bs-placement="left" data-bs-title="télécharger" download><i class="fa-solid fa-circle-down"></i></a>'.$trash.'</span>
												</li>';
											}
										}
										?>
								...
								<div id="pills-documentation" class="tab-pane fade h-100" role="tabpanel" aria-labelledby="pills-documentation-tab" tabindex="0">
									<div class="mt-2 mb-5">
										...
										<ul>
											<li><a href="https://nuitducode.github.io/DOCUMENTATION/PYTHON/TUTORIELS/1-premiers-pas-avec-pyxel-premiere/" target="_blank">Premiers pas avec Pyxel - Première</a></li>
											<li><a href="https://nuitducode.github.io/DOCUMENTATION/PYTHON/TUTORIELS/2-premiers-pas-avec-pyxel-terminale/" target="_blank">Premiers pas avec Pyxel - Terminale</a></li>
											<li><a href="https://nuitducode.github.io/DOCUMENTATION/PYTHON/TUTORIELS/3-tutoriel-detaille-terminale/" target="_blank">Tutoriel détaillé - Terminale</a></li>
										</ul>
	...
	<script>
		function run(el) {
			...
			document.getElementById('saved').innerHTML = '&#8226;';
			fadeOutEffect('saved');
			document.getElementById('pyxel_wasm').innerHTML="<iframe src='/pyxel/iframe-player/{{$token_public}}/app.py' width='100%' frameborder='0' scrolling='no' style='height:99%'></iframe>";
		}
    </script>
