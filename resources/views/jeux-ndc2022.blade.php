...
<head>
    @include('inc-meta')
    <title>Nuit du Code | Jeux 2022</title>
</head>
<body>
    ...
    <div class="container mb-5">
		<div class="row">
            ...
            <div class="col-md-2 mt-4 pr-5">
                <a class="btn btn-light btn-sm mb-4" href="/jeux-ndc" role="button"><i class="fas fa-arrow-left" aria-hidden="true"></i></a>
                <?php
                if(isset($categorie)) {
                    ?>
                    <h4>Scratch</h4>
                    <a class=" btn btn-info btn-sm btn-block text-left" href="/jeux-ndc2022/C3" role="button">Cycle 3</a>
                    <a class=" btn btn-info btn-sm btn-block text-left" href="/jeux-ndc2022/C4" role="button">Cycle 4</a>
                    <a class=" btn btn-info btn-sm btn-block text-left" href="/jeux-ndc2022/LY" role="button">Lycée</a>
                    <h4>Python</h4>
                    <a class=" btn btn-info btn-sm btn-block text-left" href="/jeux-ndc2022/P" role="button">Première</a>
                    <a class=" btn btn-info btn-sm btn-block text-left" href="/jeux-ndc2022/T" role="button">Terminale</a>
                    <?php
                } ?>
            </div>
			...
			<div class="col-md-10">
                ...
                <h1 class="mb-0">Nuit du Code 2022</h1>
                    ...
                    if (in_array($categorie, ['C3', 'C4', 'LY'])) {
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <p class="text-monospace small" style="text-align:justify">Toutes catégories confondues, plus de 1000 jeux ont été créés lors cette 6<sup>e</sup> édition de la Nuit du Code. Ci-dessous, les 2<sup>3</sup> (ou 1000<sub>2</sub>) jeux sélectionnés pour la catégorie {!! $categorie_desc !!}. Bravo aux élèves et à leurs enseignants. Amusez-vous bien!</p>
