                        ...
                        @else
                            <div class="row row-cols-1 row-cols-md-3">
                                ...
                                foreach($jeux AS $jeu){
                                    ...
                                    $evaluations[$jeu->id] = ["nom_equipe"=>$jeu->nom_equipe, "scratch_id"=>$jeu->scratch_id, "finaliste"=>$jeu->finaliste, "json"=>$json, "nb_eval_eleves"=>$nb_eval_eleves, "nb_eval_enseignants"=>$nb_eval_enseignants, "note_eleves"=>$note_eleves, "note_enseignants"=>$note_enseignants, "note"=>$note];
                                }
