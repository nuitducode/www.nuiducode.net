...
<head>
    ...
    <title>{{ config('app.name', 'Laravel') }} | Dépôt jeu Python</title>
</head>
<body>
			...
			<div class="col-md-8 offset-md-2">
                ...
                <form id="python_submit" method="POST" action="{{ route(request()->segment(1).'-jeu-deposer_post') }}" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <select id="categorie" name="categorie" class="custom-select" required>
                            <option selected disabled value="">choisir...</option>
                            <option value="PI">Première</option>
                            <option value="POO">Terminale</option>
                            <option value="PB">Post-bac</option>
                        </select>
