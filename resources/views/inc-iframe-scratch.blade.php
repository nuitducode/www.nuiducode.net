<div class="text-center">
	...
	<button type="button" class="btn btn-primary btn-sm mt-3" onClick="this.previousElementSibling.innerHTML='<iframe id=\'iframe_{{$jeu->id}}\'  src=\'https://nuitducode.github.io/ndc-lecteur-scratch/embed.html?project_url=www.nuitducode.net/storage/depot-jeux/scratch/{{strtolower($etablissement_jeton)}}/{{$jeu->scratch_id}}.sb3\' width=\'100%\' height=\'402\' allowtransparency=\'true\' frameborder=\'0\' scrolling=\'no\'></iframe>'">lancer / recharger le jeu</button>
	...
	<div class="mt-4 mb-2 text-monospace small" style="text-align:justify;color:silver">Si vous voulez voir le code ou si le jeu ne s'affiche pas correctement, vous pouvez l'ouvrir dans un autre onglet en cliquant sur <a href="https://nuitducode.github.io/ndc-lecteur-scratch/embed.html?project_url=www.nuitducode.net/storage/depot-jeux/scratch/{{strtolower($etablissement_jeton)}}/{{$jeu->scratch_id}}.sb3" target="_blank">ici</a>.</div>
