                            ...
                            foreach ($jeux AS $jeu) {
                                ...
                                <div class="row">
                                    <div class="col-md-7 text-center">
                                        ...
                                        <button type="button" class="btn btn-success btn-sm mt-3" onClick="this.previousElementSibling.innerHTML='<iframe id=\'iframe_{{$jeu->id}}\'  src=\'https://turbowarp.org/embed?project_url=www.nuitducode.net/storage/depot-jeux/scratch/{{strtolower($jeu->etablissement_jeton)}}/{{$jeu->scratch_id}}.sb3\' width=\'100%\' height=\'402\' allowtransparency=\'true\' frameborder=\'0\' scrolling=\'no\'></iframe>'">lancer / recharger le jeu</button>
                                        ...
                                        <div class="mt-4 mb-2 text-monospace small" style="color:silver">Si vous voulez voir le code ou si le jeu ne s'affiche pas correctement, vous pouvez l'ouvrir dans un autre onglet en cliquant sur <a href="https://turbowarp.org?project_url=www.nuitducode.net/storage/depot-jeux/scratch/{{strtolower($jeu->etablissement_jeton)}}/{{$jeu->scratch_id}}.sb3" target="_blank">ici</a>.</div>
